...
<head>
    ...
    <!-- Site favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="public/template/vendors/images/images/apple-touch-icon.png" />
    <link rel="icon" type="image/png" sizes="32x32" href="public/template/vendors/images/images/favicon-32x32.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="public/template/vendors/images/images/favicon-16x16.png" />
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap"
        rel="stylesheet" />
    <!-- CSS -->
    <link rel="stylesheet" type="text/css" href="public/template/vendors/styles/core.css" />
    <link rel="stylesheet" type="text/css" href="public/template/vendors/styles/icon-font.min.css" />
    <!-- Slick Slider css -->
    <link rel="stylesheet" type="text/css" href="public/template/src/plugins/slick/slick.css" />
    <!-- bootstrap-touchspin css -->
    <link rel="stylesheet" type="text/css" href="public/template/src/plugins/bootstrap-touchspin/jquery.bootstrap-touchspin.css" />
    <link rel="stylesheet" type="text/css" href="public/template/vendors/styles/style.css" />
...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
            ...
            <div class="github-link">
                <a href="https://github.com/dropways/deskapp" target="_blank"><img src="template/vendors/images/github.svg"
                        alt="" /></a>
            </div>
        </div>
    </div>
                    ...
                    <li>
                        <a href="https://dropways.github.io/deskapp-free-single-page-website-template/"
                            ...
                            <span class="mtext">Landing Page
                                <img src="template/vendors/images/coming-soon.png" alt="" width="25" /></span>
                        </a>
                    </li>
                </ul>
            </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="product-slider slider-arrow">
                                    <div class="product-slide">
                                        <img src="template/vendors/images/product-img1.jpg" alt="" />
                                    </div>
                                    <div class="product-slide">
                                        <img src="template/vendors/images/product-img2.jpg" alt="" />
                                    </div>
                                    <div class="product-slide">
                                        <img src="template/vendors/images/product-img3.jpg" alt="" />
                                    </div>
                                    <div class="product-slide">
                                        <img src="template/vendors/images/product-img4.jpg" alt="" />
                                    </div>
                                </div>
    ...
    <!-- welcome modal end -->
    <!-- js -->
    <script src="public/template/vendors/scripts/core.js"></script>
    <script src="public/template/vendors/scripts/script.min.js"></script>
    <script src="public/template/vendors/scripts/process.js"></script>
    <script src="public/template/vendors/scripts/layout-settings.js"></script>
    <!-- Slick Slider js -->
