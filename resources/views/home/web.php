...
Route::get('/product_details1/{id}',[HomeController::class,'product_details1']);// aussi hna zdt 1 ctt ma3liich ndir test

//Route::get('product_details1');// normalment hadi maklh
...
//Route::post('/commentprod',[HomeController::class, 'commentprod']);
Route::post('/add_reply',[HomeController::class, 'add_reply']);
Route::get('/product_search',[HomeController::class, 'product_search']);
Route::get('/products',[HomeController::class, 'products']);
Route::get('/search_product',[HomeController::class, 'search_product']);
Route::post('/add_rating',[RatingsController::class,'commentprod']);
//Route::get('/product/{prodId}/reviews', [RatingsController::class, 'showProductReviews']);
//Route::get('/product_details1', function () { return view('product_details1');});
//Route::get('/product_details1', function () { return view('product_details1');});
//Route::post('/comment_prod', [RatingsController::class, 'commentprod']);
