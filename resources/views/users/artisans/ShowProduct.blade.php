...
<style>
    ...
    .modern-table tbody tr:nth-child(odd) {
        background-color: #555; /* Odd row background color */
    }

    .btn {
        color: #fff;
        text-decoration: none;
        padding: 4px 8px; /* Further reduced padding for buttons */
        border-radius: 4px;
                            ...
                            <div class="card-body">
                                <table class="user-details-table">
                                    <tbody>
                                        <tr>
                                            <td class="col-md-4">
                                                <img src="{{ asset($data->image) }}" alt="{{ $data->name_prod }}" class="img-fluid custom-image">
                                            </td>
                                            <td class="col-md-8">
                                                <table class="table">
                                                    <tbody>
                                    ...
                                    <tbody>
                                      @forelse($orders as $order)
                                        <tr>
                                          ...
                                          <td> <a class="btn btn-primary" href="{{ url('/show_order', $order->id) }}">Show</a></td>
                                          @if($order->delivery_status=="processing")
                                            <td> <a class="btn btn-delivery" href="{{ url('delivered', $order->id) }}" onclick="return confirm('Are you sure this order is delivered?')">Delivery</a></td>
                                          @else
                                            <td> <a>Delivered</a></td>
                                          @endif
