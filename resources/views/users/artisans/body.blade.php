              ...
              <div class="row">
                <div class="col-9">
                  <div class="d-flex align-items-center align-self-start">
                    ...
                    <p class="text-success ml-2 mb-0 font-weight-medium">.D.A</p>
                  </div>
                </div>
                <div class="col-3">
                  <div class="icon icon-box-success ">
                ...
                <div class="row">
                  <div class="col-9">
                    <div class="d-flex align-items-center align-self-start">
                      ...
                      <p class="text-success ml-2 mb-0 font-weight-medium">O.Delivred</p>
                    </div>
                  </div>
                  <div class="col-3">
                    <div class="icon icon-box-success ">
                ...
                <div class="row">
                  <div class="col-9">
                    <div class="d-flex align-items-center align-self-start">
                      ...
                      <p class="text-success ml-2 mb-0 font-weight-medium">O.Processing</p>
                    </div>
                  </div>
                  <div class="col-3">
                    <div class="icon icon-box-success ">
